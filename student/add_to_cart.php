...
<?php include_once 'aside.php' ?>        
	...
	?>
        ...
        <td><input class="form-control" type="hidden" name="order_id" value="<?php echo $item_id; ?>" /></td>
  ...
  <td><input class="form-control" type="hidden" name="class_id" value="<?php echo $class_id; ?>" /></td>
